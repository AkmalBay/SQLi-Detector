...
<div class="max-w-3xl mx-auto">
    <div class="bg-white shadow-lg rounded-2xl p-8 border border-gray-200 dark:bg-dark-card dark:border-gray-800/50 dark:shadow-brand-blue/5">
        ...
        <div class="mb-8 border-b border-gray-200 pb-4 dark:border-gray-800">
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi detail supplier di bawah ini.</p>
        </div>
        ...
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
            ...
            <div class="mb-8">
                ...
                <textarea name="address" id="address" rows="3" 
                    class="w-full bg-white border border-gray-300 text-gray-800 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:border-transparent transition-all placeholder-gray-400 resize-none dark:bg-dark-bg dark:border-gray-700 dark:text-white dark:placeholder-gray-600">{{ old('address', $supplier->address) }}</textarea>
            </div>
